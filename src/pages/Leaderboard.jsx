...
export default function Leaderboard() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .eq("user_id", user.id)
      .then(({ data }) => setMyLeagues((data ?? []).map(r => r.leagues).filter(Boolean)));
  }, [user]);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,0.35)" }}>Ranked by group stage picks submitted</p>
      </div>
