 ...
 *   • Predicted group standings (all 12 groups)
          ...
          <div
            ...
            style={{
              ...
              background: qualifies
                ? "rgba(200,240,0,0.04)"
                : thirdBest ? "rgba(245,158,11,0.04)" : "transparent",
            }}
          >
            ...
            <div
              ...
              style={{ color: eliminated ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.55)" }}
            >
...
function KOMatch({ result, label, isChampion = false, isThirdPlace = false }) {
  ...
  const accent  = isChampion ? "#fbbf24" : isThirdPlace ? "#94a3b8" : "#c8f000";
  ...
  return (
    <div
      ...
      style={{
        ...
        border: isChampion ? "1px solid rgba(251,191,36,0.3)" : "1px solid rgba(255,255,255,0.07)",
        minWidth: 176,
      }}
    >
      {label && (
      ...
      <TeamRow team={home} pct={homePct} isWinner={winner === home} accent={accent} />
      <div style={{ height: 1, background: "rgba(255,255,255,0.05)" }} />
      <TeamRow team={away} pct={awayPct} isWinner={winner === away} accent={accent} />
    </div>
  );
}
...
function RoundColumn({ title, matches, labelFn, isThirdPlace = false }) {
  return (
      ...
      <section>
        ...
        <div className="overflow-x-auto pb-6">
          <div className="flex items-start gap-0" style={{ minWidth: 1240 }}>
            ...
            <RoundColumn title="Round of 32" matches={r32Results.slice(0, 8)}  labelFn={i => `R32 · ${i + 1}`} />
            <Connector />
            <RoundColumn title="Round of 16" matches={r16Results.slice(0, 4)}  labelFn={i => `R16 · ${i + 1}`} />
            <Connector />
            ...
            <Connector />
            <RoundColumn title="Quarterfinal" matches={qfResults.slice(2, 4)}  labelFn={i => `QF · ${i + 3}`} />
            <Connector />
            <RoundColumn title="Round of 16" matches={r16Results.slice(4, 8)}  labelFn={i => `R16 · ${i + 5}`} />
            <Connector />
            <RoundColumn title="Round of 32" matches={r32Results.slice(8, 16)} labelFn={i => `R32 · ${i + 9}`} />
